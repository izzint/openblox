...
RequestThumbnail:function(assetVersionId,width,height,imageFormat,thumbnailFormatID,succeededCallback, failedCallback, userContext) {
return this._invoke(this._get_path(), 'RequestThumbnail',true,{assetVersionId:assetVersionId,width:width,height:height,imageFormat:imageFormat,thumbnailFormatID:thumbnailFormatID},succeededCallback,failedCallback,userContext); }}
...
Roblox.Thumbs.Asset.RequestThumbnail= function(assetVersionId,width,height,imageFormat,thumbnailFormatID,onSuccess,onFailed,userContext) {Roblox.Thumbs.Asset._staticInstance.RequestThumbnail(assetVersionId,width,height,imageFormat,thumbnailFormatID,onSuccess,onFailed,userContext); }
...
/*
     FILE ARCHIVED ON 13:36:34 Jun 04, 2009 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:10:34 Jan 30, 2022.
...
/*
playback timings (ms):
  captures_list: 1070.375
  exclusion.robots: 150.971
  exclusion.robots.policy: 150.962
  xauthn.identify: 108.858
  xauthn.chkprivs: 41.839
  RedisCDXSource: 0.897
  esindex: 0.011
  LoadShardBlock: 889.077 (3)
  PetaboxLoader3.datanode: 565.162 (7)
  PetaboxLoader3.resolve: 158.659 (4)
  CDXLines.iter: 18.449 (2)
  load_resource: 41.186
*/